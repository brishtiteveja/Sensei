...
function build(dict: Dict) {
  ...
  return {
    ...
    tour: {
      ...
      nbNoteTitle: s('tour.nbNoteTitle'),
      nbNoteBody: s('tour.nbNoteBody'),
      nbSketchTitle: s('tour.nbSketchTitle'),
      nbSketchBody: s('tour.nbSketchBody'),
      nbImageTitle: s('tour.nbImageTitle'),
      nbImageBody: s('tour.nbImageBody'),
      nbPhoneTitle: s('tour.nbPhoneTitle'),
      ...
      coProgressBody: s('tour.coProgressBody'),
      skip: s('tour.skip'),
      next: s('tour.next'),
      done: s('tour.done'),
